...
func (x *Tenant) Reset() {
	*x = Tenant{}
	mi := &file_go_app_tenant_proto_msgTypes[0]
...
var File_go_app_tenant_proto protoreflect.FileDescriptor

const file_go_app_tenant_proto_rawDesc = "" +
	"\n" +
	"\x13go_app/tenant.proto\x12\x06go_app\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\torm.proto\"\xba\x02\n" +
	"\x06Tenant\x12\x1b\n" +
	...
	"\x06labels\x18\a \x03(\v2\x1a.go_app.Tenant.LabelsEntryR\x06labels\x12H\n" +
	...
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01:\b\xca\xfc\x15\x04\x12\x02\x10\x01J\x04\b\x02\x10\x03J\x04\b\x03\x10\x04B!Z\x1agithub.com/lesomnus/go-app\x92\x03\x02\b\x02b\beditionsp\xe8\a"

var file_go_app_tenant_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_go_app_tenant_proto_goTypes = []any{
	(*Tenant)(nil),                // 0: go_app.Tenant
	nil,                           // 1: go_app.Tenant.LabelsEntry
	(*timestamppb.Timestamp)(nil), // 2: google.protobuf.Timestamp
}
var file_go_app_tenant_proto_depIdxs = []int32{
	1, // 0: go_app.Tenant.labels:type_name -> go_app.Tenant.LabelsEntry
	2, // 1: go_app.Tenant.date_created:type_name -> google.protobuf.Timestamp
...
func init() { file_go_app_tenant_proto_init() }
func file_go_app_tenant_proto_init() {
	if File_go_app_tenant_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_go_app_tenant_proto_rawDesc), len(file_go_app_tenant_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_go_app_tenant_proto_goTypes,
		DependencyIndexes: file_go_app_tenant_proto_depIdxs,
		MessageInfos:      file_go_app_tenant_proto_msgTypes,
	}.Build()
	File_go_app_tenant_proto = out.File
	file_go_app_tenant_proto_goTypes = nil
	file_go_app_tenant_proto_depIdxs = nil
}
