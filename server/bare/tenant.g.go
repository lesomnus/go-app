...
func (s TenantServiceServer) apply(ctx context.Context, ref *go_app.TenantRef, doc *patchpb.Patch, by string) (*go_app.Tenant, error) {
...
func (s TenantServiceServer) Erase(ctx context.Context, req *go_app.TenantRef) (*emptypb.Empty, error) {
	...
	if n > 0 {
		if err := record(ctx, s.Rec, st.Db, Change{
			By:  go_app.TenantService_Erase_FullMethodName,
			Key: k,
		}); err != nil {
			return nil, err
		}
