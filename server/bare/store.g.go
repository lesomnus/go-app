...
func (s Server) Audit() go_app.AuditServiceServer   { return AuditServiceServer{Db: s.Db, Rec: s.Rec} }
func (s Server) Tenant() go_app.TenantServiceServer { return TenantServiceServer{Db: s.Db, Rec: s.Rec} }
func (s Server) Holder() go_app.HolderServiceServer { return HolderServiceServer{Db: s.Db, Rec: s.Rec} }
